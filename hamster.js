...
class agent {
    ...
    secondhalf() { //determines if the agent is already past the midpoint of its current tile
    ...
    update(delta) {
        ...
        if (this.req_d != this.cur_d) {
            ...
            //Turning 180 degrees happens instantly
...
function draw() {
    ...
    ctx.fillText("Change difficulty with A/S keys", 8 * tile, (gameHeight + 2) * tile);
